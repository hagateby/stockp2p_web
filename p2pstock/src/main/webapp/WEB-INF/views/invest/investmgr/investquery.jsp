...
<!--nav end-->
 <div class="container_12">
	...
	<s:form action="/sysmgr/queryIssurInfo_issueMgrAction.action" method="post" theme="simple" id="hisinvestform">
	<div class="p20bs color-white-bg fn-clear" id="hisdiv">
		<fieldset style="border:0px">
			<legend class="fieldset-lgend">历史产品列表</legend>
			<br/>
			<div id="hisinvestdiv"></div>
		</fieldset>
	</div>
	</s:form>
