...
<table>
	<tr>
		...
		<td class="tbl_td_20 tbl_tdtitle160">投资收益率</td>
	</tr>
	<s:iterator value="investlist" status="s">
		<tr>
			...
			<s:if test="invt_product_status == 0">
				<td class="tbl_td_20">已过期</td>
				<td class="tbl_td_20"></td>		
			</s:if>
			<s:if test="invt_product_status == 3">
				<td class="tbl_td_20">已开签</td>
				<td class="tbl_td_20"></td>
			</s:if>
			<s:if test="invt_product_status == 2 || invt_product_status == 4 || invt_product_status == 5">
				<td class="tbl_td_20"><s:property value="invt_product_statusname"/></td>
				<td class="tbl_td_20"><s:property value="invest_rate"/>%</td>
			</s:if>
		</tr>
	</s:iterator>
	<tr>
