...
<div class="grid_10">
	...
	<s:form action="/sysmgr/queryTranInfo_fundMgrAction.action" method="post" theme="simple" id="queryform">
	<div class="p20bs color-white-bg fn-clear">
		...
		<table>
			<tr>
				...
				<td class="tbl_td_15_b">
					<input type="text" id="user_name" style="width:140px" name="tranInfoVo.user_name" value="${tranInfoVo.user_name}"/>
				</td>
		 	</tr>
		 	<tr>
		 			...
		 			<div style="*z-index:21;">
	            		<div class="ui-selectdrop-new" style="padding-left:5px">
		              		<div class="s_select_bg_new het35" style="left:195px;top:360px;width:150px;align:center" id="secPrtStatusBtn"">
				                <span class="txt_new fn-clear"><em id="secprtstatuspdis"><s:property value="tranInfoVo.payment_typename"/></em></span><span><em class="arrow_new2" style="left:280px"></em></span>
		             		</div>
