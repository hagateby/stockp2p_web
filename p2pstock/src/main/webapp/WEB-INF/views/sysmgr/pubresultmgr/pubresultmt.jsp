...
<div class="grid_10">
	...
	<s:form action="/ajax/checkInvestAjax_pubResultMgrAction.action" method="post" theme="simple" id="checkform">
		<s:hidden id="ajaxinvt_product_id" name="ajaxinvt_product_id"></s:hidden>
	</s:form>
	<s:form action="/pubresult/moreIssueInfo_issueMgrAction.action" method="post" theme="simple" id="pubform">
		<s:hidden id="invt_product_id" name="investProductVo.invt_product_id"></s:hidden>
	</s:form>
	<s:form action="/settle/moreIssueInfo_issueMgrAction.action" method="post" theme="simple" id="settleform">
		<s:hidden id="settleinvt_product_id" name="investProductVo.invt_product_id"></s:hidden>
	</s:form>
	...
	<s:form action="/pubresult/queryIssurInfo_issueMgrAction.action" method="post" theme="simple" id="queryform">
			...
			<table>
				<tr><td height="20px"></td></tr>
			 	...
			 	<tr>
			 		...
			 		<td class="tbl_td_15_b">
			 			<input id="lot_date" name="investProductVo.start_date"  class="Wdate" type="text"  onFocus="WdatePicker({lang:'zh-cn',isShowClear:true})" value="${investProductVo.start_date}"/>
			 		</td>				 	
			 		<td class="tbl_td_15_b tbl_td_lbcolor">终止时间</td>
			 		<td class="tbl_td_15_b">
			 			<input id="start_date" name="investProductVo.end_date"  class="Wdate" type="text" onFocus="WdatePicker({lang:'zh-cn',isShowClear:true})" value="${investProductVo.end_date}"/>
			 		</td>
			 	</tr>
			 	<tr>
		            		...
		            		<div class="ui-selectdrop-new" style="padding-left:5px">
			              		<div class="s_select_bg_new het35" style="left:195px;top:360px;width:150px;align:center" id="secPrtStatusBtn">
					                <span class="txt_new fn-clear">
					                	<em id="secprtstatuspdis"><s:property value="investProductVo.invt_product_statusname"/></em></span>
					                <span>
			...
			<table>
				...
				<s:iterator value="investlist" status="s">
					<tr>
						...
						<td class="tbl_td_20"><a href="javascript:moreinfo('${invt_product_id}','${invt_product_status}');">录签</a> <a href="javascript:settle('${invt_product_id}','${invt_product_status}');">结算</a></td>		
					</tr>
				</s:iterator>
				<tr>
					<td colspan="7">
