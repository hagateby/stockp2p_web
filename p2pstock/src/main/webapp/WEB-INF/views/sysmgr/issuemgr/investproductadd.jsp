...
<html>
<head>
<script type="text/javascript" src="/p2pstock/static/js/sysmgr/issuemgr/investproductadd.js"></script>
...
<div class="grid_10">
	...
	<div class="p20bs color-white-bg fn-clear" id="maindiv">
		...
		<s:form action="/sysmgr/addIssurSub_issueMgrAction.action" method="post" theme="simple" id="saveform">
				...
				<tr><td height="20px" ></td></tr>
			 	<tr>
			 		...
			 		<td class="tbl_td_15_b">
			 			<input type="text" id="invt_product_name" name="investProductVo.invt_product_name" onblur="checkprdtname();"/>
			 		</td>
			 	...
			 	<tr>
			 		...
			 		<td class="tbl_td_15_b">
			 			<input type="text" id="amount" name="investProductVo.amount"/>元
			 		</td>
			 		<td  class="tbl_td_15_b tbl_td_lbcolor">发起投资管理费</td>
			 		<td class="tbl_td_15_b">
			 			<label id="issue_fee" style="color:red;">0</label>元
			 			<input type="hidden" id="issue_feetxt" name="investProductVo.issue_fee" value="0">
			 		</td>
			 	</tr>
			 	<tr>
			 		<td  class="tbl_td_15_b tbl_td_lbcolor">投资人管理费计提方式</td>
			 		<td class="tbl_td_15_b">
			 			<s:hidden id="user_accruedcharges_type" name="investProductVo.user_accruedcharges_type" value="0"></s:hidden>
		            		...
		            		<div class="ui-selectdrop-new" style="padding-left:5px">
			              		<div class="s_select_bg_new het35" style="left:195px;top:360px;width:150px;align:center" id="secAccChargeTypBtn">
					                <span class="txt_new fn-clear">
					                	<em id="secaccchargetypdis">按比例</em></span>
					                <span>
					                	<em class="arrow_new2" style="left:320px"></em>
					                </span>
			             		</div>
			 		...
			 		<td class="tbl_td_15_b">
			 			<input type="text" id="user_accruedcharges_amount" name="investProductVo.user_accruedcharges_amount" style="width:100px" maxlength="12" onkeyup="value=value.replace(/[^\d.]/g,'')"/>
			 	...
			 	<tr>
		    		...
		    		<!-- 需求不明确，1期暂不支持按比例提取 -->
			 		...
			 		<td class="tbl_td_15_b">
			 			<input type="text" id="invester_bail" name="investProductVo.invester_bail" style="width:100px" maxlength="12" onkeyup="value=value.replace(/[^\d.]/g,'')"/>%
			 		</td>
			 		<td class="tbl_td_15_b tbl_td_lbcolor" style="width:120px">发起人管理费计提比例:</td>
			 		<td class="tbl_td_15_b">
			 			<input type="text" id="launcher_accruedcharges_amount" name="investProductVo.launcher_accruedcharges_amount" style="width:100px" maxlength="12" readonly = true value="0.00"/>%
			 		</td>
			 	...
			 	<tr>
			 		...
			 		<td class="tbl_td_15_b">
			 			...
			 			<input type="hidden" id="start_date" name="investProductVo.start_date" >
			 		</td>				 	
			 		<td  class="tbl_td_15_b tbl_td_lbcolor">终止时间</td>
			 		<td class="tbl_td_15_b">
			 			<label id="end_date_label"></label>
			 			<input type="hidden" id="end_date" name="investProductVo.end_date" >
			 		</td>
			 	</tr>
		...
		<div id="binddiv" style="display:block">
			<fieldset style="border:0px">
				<legend class="fieldset-lgend">已选择基础标的</legend>
				<input type="hidden" id="base_product_idarray" name="investProductVo.base_product_idarray"/>
				<table id="bindtbl">
				</table>
			</fieldset>
		</div>
		...
		<div>
			...
			<input type="hidden" id="startdatearray"/>
			<input type="hidden" id="enddatearray"/>
			<fieldset style="border:0px">
