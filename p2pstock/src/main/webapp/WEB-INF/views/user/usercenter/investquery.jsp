...
<html>
<head>
<script type="text/javascript" src="/p2pstock/static/js/user/usercenter/investquery.js"></script>
...
<div class="grid_10">
		<form method="post" id="moreForm" action="/p2pstock/usercenter/queryInvestMore_investMgrAction.action">
			<input type="hidden" id="user_invest_id" name="user_invest_id" />
		</form>
		<form method="post" id="editForm" action="/p2pstock/usercenter/editInit_investMgrAction.action">
			<input type="hidden" id="euser_invest_id" name="user_invest_id" />
		</form>
		<form method="post" id="queryForm" action="/p2pstock/usercenter/queryInvest_investMgrAction.action">
			...
			<fieldset style="border:0px">
				...
				<table style="width:850px">
					<tr>
						...
						<td class="tbl_td_20 tbl_tdtitlecolor"  style="width:140px">投资额</td>
						<td class="tbl_td_20 tbl_tdtitlecolor"  style="width:140px">保证金</td>
						...
						<tr>
							...
							<td class="tbl_td_20 ">
								<s:if test=" editflag == 1 ">
									<a href="javascript:editinfo('${user_invest_id}');">修改</a>
								</s:if>
								
								<a href="javascript:moreinfo('${user_invest_id}');">详情</a>
							</td>		
						</tr>
					</s:iterator>
					<tr>
