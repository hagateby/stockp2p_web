...
<!--nav end-->
 <div class="container_12">
 	<div style="position: absolute;padding-top:150px;padding-left:300px;font-size:20px;font-weight:600;">恭喜您注册成功，欢迎来到众筹平台</div>
	<div class="p20bs color-white-bg fn-clear">
		...
		<div style="padding-top:30px;padding-left:350px">
			<input type="button" onclick = "logininfo()" class="ui-button-rrd-blue ui-button-rrd-blue-large" value="立即登录"/>
			<input type="button" onclick = "returnhome()" class="ui-button-rrd-blue ui-button-rrd-blue-large" value="返回首页"/>
		</div>
	</div>
</div>
</body>
