package com.p2p.webapp.sysmgr.productmgr.entity;
...
public class BaseProduct {
	...
	//资金解冻日期
	private String fundfree_date;
	//中签率
	private String lot_rate;
	//投资类型
	...
	public String getFundfree_date() {
		return fundfree_date;
	}
	public void setFundfree_date(String fundfreeDate) {
		fundfree_date = fundfreeDate;
	}
	public String getLot_rate() {
		return lot_rate;
	}
	public void setLot_rate(String lotRate) {
		lot_rate = lotRate;
	}
	public String getApply_code() {
		return apply_code;
	}
	public void setApply_code(String applyCode) {
