...
public class InvestMoreInfo {
	...
	public void setInvt_product_id(String invtPrdouctId) {
		invt_product_id = invtPrdouctId;
	}
	...
	public void setResult_flag(String resultFlag) {
